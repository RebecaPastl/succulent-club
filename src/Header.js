        ...
        return <>
            ...
            <header>
                ...
                <Card border="light">
                    ...
                    <Card.ImgOverlay> 
                        <Card.Title>
                            <h1 className='header-h1 green-header mx-lg-5 mt-5 float-left text-center opacity-4'>Succulent <span className="d-block">Club</span></h1>
                        </Card.Title>
                    </Card.ImgOverlay>
                    <Card.ImgOverlay className='d-flex flex-column justify-content-end text-center'>
                        <Card.Text>
                            <Arrow className='arrow green-header'/>
                        </Card.Text>
                    </Card.ImgOverlay>
                </Card>
            </header>
